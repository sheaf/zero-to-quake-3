...
-- zero-to-quake-3
import Math.Linear ( V(..), pattern V2, pattern V3, pattern V4 )
...
v2_32sfloat :: VertexFormat ( V 2 Foreign.C.CFloat )
v2_32sfloat =
  mkVertexFormat Vulkan.VK_FORMAT_R32G32_SFLOAT


v3_32sfloat :: VertexFormat ( V 3 Foreign.C.CFloat )
v3_32sfloat =
  mkVertexFormat Vulkan.VK_FORMAT_R32G32B32_SFLOAT


v4_8uint :: VertexFormat ( V 4 Word8 )
v4_8uint =
